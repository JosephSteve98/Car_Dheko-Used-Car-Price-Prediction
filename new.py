...
model = joblib.load(r"C:\Users\lejoc\OneDrive\Desktop\PROJECTS\Car Dehko\final_random_forest_model1.pkl")
label_encoders = joblib.load(r"C:\Users\lejoc\OneDrive\Desktop\PROJECTS\Car Dehko\label_encoder.pkl")
scalers = joblib.load(r"C:\Users\lejoc\OneDrive\Desktop\PROJECTS\Car Dehko\min_max.pkl")  # Assuming this is your loaded scaler for inverse transformation

# Load dataset for filtering and identifying similar data
data = pd.read_csv(r'C:\Users\lejoc\OneDrive\Desktop\PROJECTS\Car Dehko\cleaned_cardata.csv')
